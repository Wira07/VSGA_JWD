  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <br><br>
        <h1>PROFILE</h1><br>
        <p class="lead">viXbec berdiri pada 09 Maret 2010 di Bekasi. Di dirikan oleh 15 orang yang merupakan angkatan pertama diantaranya Bro Deni, Bro Irman, Bro Hadi, Sist Achie dan kawan-kawan.<br> Komunitas ini bertujuan Sebagai wadah penyaluran hobby, komunikasi, dan mempererat silahturahmi, persaudaraan  antar sesama anggota.</p>
        <br><br>
      </div>
    </div>
