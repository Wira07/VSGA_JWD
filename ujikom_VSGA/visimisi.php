  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <p class="lead">
          <h4>BROTHERHOOD</h4>
          Semua adalah Saudara, dan persaudaraan tidak dibatasi dengan apapun.<br><br>
          <h4>SOCIAL</h4>
          Aware of social responsibility, Kegiatan kami tidak hanya turing dan kumpul-kumpul saja, akan tetapi Agenda yang diselenggarakan oleh PAVI konsentrasi kepada sosial.
          <br><br>
          <h4>VIGILANTE</h4>
          We are unity, kita satu walaupun berbeda-beda latar blakang club, logo, atribut dll.</p>
        <br><br>
      </div>
    </div>
