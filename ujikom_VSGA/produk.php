  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <h1>PRODUK</h1><br>
        <p class="lead">
          <a href="produk_input.php"><button type="button" class="btn btn-primary">Tambah Produk</button></a>
          <br>
        <table class="table">
          <thead>
            ...
            <?php
              while ($row = mysqli_fetch_array($cek)) {
                  echo "<tr>
                        ...
                        <td>$row[jumlah]</td>
                        <td>
                        <a href='produk_edit.php?id=$row[idproduk]'><button type='button' class='btn btn-warning'>Edit</button></a>
                        </td>
                        <td>
                        <a href='produk_hapus.php?id=$row[idproduk]'><button type='button' class='btn btn-danger'>Hapus</button></a>
                        </td>
                        </tr>";
            }
          ?>
